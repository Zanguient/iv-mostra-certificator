...
exports.sendPasswordResetTokenEmail = function(user, passwordResetLink, siteBaseUrl, cb){
  var smtpTransport;
  var options = {};

  options.email = user.email;
  options.subject = sails.config.appName + ' | Recuperar senha';
  ...
  var templateVariables = {
    ...
    confirmUrl: passwordResetLink
  };

  var templateName = 'PasswordResetTokenEmail';
